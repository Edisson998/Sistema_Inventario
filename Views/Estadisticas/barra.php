...
$sql = "select COUNT(*) from tbl_pedido_cabecera where PED_FECHA between '$desdee' and '$hastae'";
...
$sql = "select COUNT(*) from tbl_pedido_cabecera where PED_FECHA between '$desdef' and '$hastaf'";
$result = $co->query($sql);//$pdo sería el objeto conexión
...
$sql = "select COUNT(*) from tbl_pedido_cabecera where PED_FECHA between '$desdem' and '$hastam'";
$result = $co->query($sql);//$pdo sería el objeto conexión
...
$sql = "select COUNT(*) from tbl_pedido_cabecera where PED_FECHA between '$desdea' and '$hastaa'";
$result = $co->query($sql);//$pdo sería el objeto conexión
...
$sql = "select COUNT(*) from tbl_pedido_cabecera where PED_FECHA between '$desdema' and '$hastama'";
$result = $co->query($sql);//$pdo sería el objeto conexión
...
$sql = "select COUNT(*) from tbl_pedido_cabecera where PED_FECHA between '$desdej' and '$hastaj'";
$result = $co->query($sql);//$pdo sería el objeto conexión
...
$sql = "select COUNT(*) from tbl_pedido_cabecera where PED_FECHA between '$desdeag' and '$hastaag'";
$result = $co->query($sql);//$pdo sería el objeto conexión
...
$sql = "select COUNT(*) from tbl_pedido_cabecera where PED_FECHA between '$desdes' and '$hastas'";
$result = $co->query($sql);//$pdo sería el objeto conexión
...
$sql = "select COUNT(*) from tbl_pedido_cabecera where PED_FECHA between '$desdes' and '$hastao'";
$result = $co->query($sql);//$pdo sería el objeto conexión
...
$sql = "select COUNT(*) from tbl_pedido_cabecera where PED_FECHA between '$desden' and '$hastan'";
$result = $co->query($sql);//$pdo sería el objeto conexión
...
$sql = "select COUNT(*) from tbl_pedido_cabecera where PED_FECHA between '$desded' and '$hastad'";
$result = $co->query($sql);//$pdo sería el objeto conexión
